...
public class FavoriteActivity extends MainBaseActivity {
    List<Item> items = new ArrayList<>();
    LinearLayout favorite_BackBtn,fav_none;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        favorite_BackBtn = (LinearLayout) findViewById(R.id.favorite_BackBtn);
        fav_none = (LinearLayout) findViewById(R.id.fav_none);
        ...
        favorite_BackBtn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    protected void onResume() {
        ...
        Log.d("email",email);
        try {
            String favorite = new TaskMethod("http://creativerowan.com/bookmerang/myFavoriteBook.jsp","email="+email, "UTF-8").execute().get();
            if (favorite == null){
                Log.d("return","null");
            } else {
                ...
                if(jsonArrays.length()==0){
                    ...
                    fav_none.setVisibility(View.VISIBLE);
                }else{
                    fav_none.setVisibility(View.GONE);
